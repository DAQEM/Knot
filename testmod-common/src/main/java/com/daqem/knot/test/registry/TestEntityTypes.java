...
public interface TestEntityTypes {
    ...
    KnotRegistry<EntityType<?>> ENTITY_TYPES = Knot.REGISTRAR.createRegistry(BuiltInRegistries.ENTITY_TYPE, Test.MOD_ID);
    ...
    static void register() {
        ...
        Knot.ENTITY_ATTRIBUTES.registerAttributes(TEST_ENTITY, Pig::createAttributes);
    }
}