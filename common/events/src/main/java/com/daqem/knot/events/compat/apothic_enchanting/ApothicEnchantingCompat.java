...
public class ApothicEnchantingCompat {
    ...
    public static ApothicEnchantingCompat getInstance() { return INSTANCE; }

    public void setCapturedCost(int cost) { this.capturedCost.set(cost); }
    ...
    public void clearCapturedCost() { this.capturedCost.remove(); }
}