...
public class KnotGlobalPackRepository extends FolderRepositorySource {
    ...
    public KnotGlobalPackRepository(Path folder, PackType packType, PackSource packSource) {
    ...
    public void loadPacks(@NotNull Consumer<Pack> consumer) {
        try {
            ...
            KnotMod.API.error("Failed to load global packs from {}", this.folder, e);
        }
    }
}