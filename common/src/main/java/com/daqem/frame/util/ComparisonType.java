package com.daqem.frame.util;

import com.daqem.frame.codec.FrameStreamCodecs;
...
public enum ComparisonType implements StringRepresentable {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, ComparisonType> STREAM_CODEC = FrameStreamCodecs.enumCodec(ComparisonType.class);
